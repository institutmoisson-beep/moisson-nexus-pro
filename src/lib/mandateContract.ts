...
export const generateMandateContractPDF = (data: MandateContractData): void => {
  ...
  const purchaseDateStr = new Date(data.purchaseDate).toLocaleDateString("fr-FR", {
    day: "numeric",
    month: "long",
    year: "numeric",
  });
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .status-banner{background:linear-gradient(135deg,rgba(124,58,237,0.06),rgba(212,160,23,0.06));border:2px solid rgba(124,58,237,0.2);border-radius:12px;padding:16px 20px;margin-bottom:28px;display:flex;align-items:center;justify-content:space-between;}
